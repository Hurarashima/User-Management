...
if (isset($_POST['submit'])) {
    ...
    if ($result_email == 0) {
        ...
        if ($result == 0) {
            ...
            $insert_user = mysqli_query($conn, "INSERT INTO tbl_users (firstname, middlename, lastname, username, password, email) VALUES ('$firstname', '$middlename', '$lastname', '$username', '$hashedpass', '$email')");
